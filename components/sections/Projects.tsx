...
const projects = [
  ...
  },
  {
    ...
    description:
      'A modern web application designed to digitize the traditional process of scheduling property viewings. Behaving like an "Airbnb for Property Buy/Sell Visits," it allows users to browse exclusive listings and book paid site visits instantly.',
    technologies: [
      'React',
      'Firebase',
      'Framer Motion',
    ...
    github: 'https://github.com/gunjivinay/Real-Estate-Property-Visit-Booking-Platform',
    live: 'https://real-estate-booking-plat-af248.web.app/',
    achievements: [
